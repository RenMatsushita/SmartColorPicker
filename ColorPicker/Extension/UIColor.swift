...
extension UIColor {
    ...
    class func rgb(rgbValue: RGBValue) -> UIColor {
    ...
    /// selfの色からrgb値を抽出し返す
    func colorToRGBValue() -> RGBValue {
        guard let cgColorValues = self.cgColor.components else { return RGBValue() }
        ...
        return RGBValue(redValue: redValue, greenValue: greenValue, blueValue: blueValue)
    }
}
